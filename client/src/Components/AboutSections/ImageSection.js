...
function ProfileDetails() {
  ...
  return (
    <div className="profileDetails" >
      ...
      <div className="profileDetails__profile-img" ></div>
      ...
      <div className="profileDetails__about-info" >
        ...
        as a web developer as it has provided me with keen attention to detail,
        the ability to persevere, to refine until excellence achieved, to be
        self-disciplined, and the skill to coordinate multiple tasks at once.
        I believe in the power of technology as a modern tool for transforming
        the status quo of our current generation.
        </p>
      </div>
